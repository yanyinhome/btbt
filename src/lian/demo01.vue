<template>
    ...
    <div class="back-l" ref="left">
            <div class="caiwu_div3" >
               ...
               <p class="jiao">￥ {{money.money}}</p>
                <p class="jiao" v-if="money.money==''">￥ 0.00</p>
               </div>
            </div>
  <div class="back-r" ref="right">
            <div class="caiwu_div4">
               ...
               <p class="jiao" v-if="money.wk_money==''">￥ 0.00</p>
               </div>
               </div>
 <div class="back-c" ref="right">
             <div class="caiwu_div44">
               <p class="jiao">产量账户</p>
               <p class="caiwu_p1">BT {{money.btb}}</p>
               <p class="jiao">￥ {{money.btb_money}}</p>
                <p class="jiao" v-if="money.btb_money==''">￥ 0.00</p>
               </div>
               </div>
        </div>
        <div class="caiwu_div5">
                <div class="caiwu_div6">
                    <p class="caiwu_p2"></p>
                    <p class="caiwu_p3">BT资产：￥{{money.jy}}</p>
                    <p class="caiwu_p11"></p>
  ...
  data() {
    return {
      ...
      options: {
        ...
        color: ["#ffa51e ", "#2978CD", "#532BAF", "#8E1818"],
        legend: {
          orient: "vertical",
          x: "left",
  ...
  created() {
    ...
    this.axios
      ...
      .then(res => {
        ...
        this.options.series[0].data[1].value = res.data.data.btb_money;
        this.options.series[0].data[0].value = res.data.data.jy;
        this.options.series[0].data[2].value = 0;
        this.options.series[0].data[3].value = 0;
        // console.log(this.options.series[0].data[4].value)
        this.drawLine();
      });
    var app = this;
...
.caiwu_div44 {
  ...
  color: #fff;
  font-size: 25px;
  background: url("../assets/image/jianbian.png");
}
.jiao {
  font-size: 20px;
  margin-top: -6px;
